...
export const UI_TRANSLATIONS: Record<string, TranslationSet> = {
  en: {
    ...
    tabPortal: "Interactive NSW Portal",
    tabAI: "AI Fraud & Predictive Center",
    ...
    tabDatabase: "Database & Schema Model",
    tabDevOps: "Cloud DevOps & Kubernetes IaC",
    tabWorkspace: "Sovereign Repo Workspace",
    tabQA: "Automated Testing & QA Desk",
  ...
  ar: {
    ...
    tabPortal: "بوابة المعاملات التفاعلية",
    tabAI: "مركز الذكاء الاصطناعي للتنبؤ ومكافحة الاحتيال",
    ...
    tabDatabase: "قاعدة البيانات والنموذج الهيكلي",
    tabDevOps: "إدارة السحابة والبنية التحتية (DevOps IaC)",
    tabWorkspace: "مستودع الأكواد السيادي",
    tabQA: "ضمان الجودة وأتمتة الاختبارات (QA/Testing)",
  ...
  ku: {
    ...
    tabPortal: "پۆڕتاڵی کارلێککار",
    tabAI: "سەنتەری ژیری دەستکردی دژە فێڵ و فێڵکاری",
    ...
    tabDatabase: "دیزاینی داتابەیس و مۆدێلی زانیاری",
    tabDevOps: "سەنتەری حوسبەی سحابی و ئۆتۆماتیک (DevOps IaC)",
    tabWorkspace: "کۆگای کۆدی سەروەری",
    tabQA: "تاقیگە و خۆکارکردنی تاقیکردنەوەکان (Testing & QA)",
